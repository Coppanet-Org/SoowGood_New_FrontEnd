...
export class UploadAppointmentDocDialogComponent {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public patientId: any | undefined
  ...
  savePreviousDocument() {
    ...
    if (this.selectedFileName) {
      ...
      this.fileData.append("directoryName", "PatientPreviousDocuments\\" + this.patientId.toString());
      ...
      this.http.post(`${this.apiUrl}/Common/Documents`, this.fileData).subscribe(
        (result: any) => {
          ...
          this.TosterService.customToast('Your previous document sucessfully send your doctor.', 'success');
